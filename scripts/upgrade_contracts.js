...
async function main() {
    ...
    try {
        ...
        console.error("❌ Failed to upgrade HalomToken:", error.message);
    }
    ...
    try {
        ...
        console.error("❌ Failed to upgrade HalomTreasury:", error.message);
    }
    ...
    try {
        ...
        console.error("❌ Failed to upgrade HalomOracleV2:", error.message);
    }
    ...
    try {
        ...
        console.error("❌ Failed to upgrade HalomStaking:", error.message);
    }
    ...
    try {
        ...
        console.error("❌ Failed to upgrade HalomLPStaking:", error.message);
    }
...
main()
    ...
    .catch((error) => {
        console.error("❌ Contract upgrade script failed:", error);
        process.exit(1);
    }); 